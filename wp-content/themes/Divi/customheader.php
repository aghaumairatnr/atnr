...
})(window,document,'script','dataLayer','GTM-TQP9G3Q');</script>
...
<?php
	...
	<?php wp_head(); ?>
	<meta name="google-site-verification" content="d_hEOLo0Bkjy_4sbc-bteMIGASXihxF6rp12QtsIV4o" />
<meta name="google-site-verification" content="hhBuUALWtu2J2NkfNKtv8fXTuOnpdXdin2u19mjU4_c" />

</head>
<body   
<?php body_class(); ?>>
	<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TQP9G3Q"
...
<div id="slider" class="form-wrapper-div">
		<div id="sidebar2"><img src="<?php bloginfo('template_directory'); ?>/images/button.png"></div>
            <div class="">
            ...
            <div class="">
                <div class="">
                   <?php echo do_shortcode('[contact-form-7 id="337" title="Slide Form"]'); ?>
                </div>
            </div>
        </div>
